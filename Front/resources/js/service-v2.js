(function () {
  ...
  var meals = {
    breakfast: { label: '조식', time: '07:30–09:00', cards: [{ id: 'a', type: '한식', name: '된장국 정식', photo: '../../resources/images/menu/doenjangguk-photo.png', items: [['잡곡밥', 300], ['된장국', 120], ['계란말이', 150], ['시금치나물', 40]], origin: '쌀(국내산), 두부(외국산)', allergens: '대두, 계란, 밀', macro: { total: 540, carb: 180, protein: 70, fat: 40, sodium: 1050 } }] },
    lunch: { label: '중식', time: '11:30–13:30', cards: [{ id: 'a', type: '한식', name: '제육볶음 정식', photo: '../../resources/images/menu/jeyuk-bokkeum-photo.png', items: [['잡곡밥', 300], ['제육볶음', 280], ['계란찜', 120], ['시금치나물', 40], ['배추김치', 30], ['된장국', 120]], origin: '돼지고기(국내산), 쌀(국내산)', allergens: '대두, 계란, 밀', macro: { total: 890, carb: 210, protein: 120, fat: 90, sodium: 1480 } }, { id: 'b', type: '한식', name: '비빔밥 코너', photo: '../../resources/images/menu/bibimbap-photo.png', items: [['흰쌀밥', 300], ['나물 5종', 150], ['계란후라이', 110], ['고추장', 30]], origin: '쌀(국내산), 소고기(호주산)', allergens: '대두, 계란, 밀, 쇠고기', macro: { total: 790, carb: 195, protein: 85, fat: 75, sodium: 1290 } }] },
    dinner: { label: '석식', time: '17:30–19:00', cards: [{ id: 'a', type: '한식', name: '순두부찌개 정식', photo: '../../resources/images/menu/sundubu-jjigae-photo.png', items: [['흰쌀밥', 300], ['순두부찌개', 210], ['계란후라이', 110], ['어묵볶음', 90]], origin: '쌀(국내산), 돈육(국내산)', allergens: '대두, 계란, 밀, 우유', macro: { total: 710, carb: 185, protein: 95, fat: 80, sodium: 1390 } }] }
  };
  var weeks = {
